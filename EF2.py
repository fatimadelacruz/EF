 ...
 "cells": [
  {
   ...
   "id": "b189823e-0b30-4f36-a491-a45ed858f0b2",
   "metadata": {},
   "outputs": [
    {
     "data": {
  ...
  },
  {
   "cell_type": "code",
   "execution_count": null,
   "id": "d75f9bf3-f018-46da-a50e-81986f59e048",
   "metadata": {},
   "outputs": [
    {
     "data": {
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 40,
   "id": "fa0be01b-c836-4a9a-aa7d-b904eae3f23f",
   "metadata": {},
   "outputs": [
    {
     "data": {
   ...
   "source": [
    ...
    "import pandas as pd\n",
    "df_airbnb = pd.read_csv(\"airbnb.csv\")\n",
    "con1 = df_airbnb[(df_airbnb.bedrooms==2) & \n",
    "                 (df_airbnb.reviews>10) & \n",
    "                 (df_airbnb.overall_satisfaction>4)]\n",
    "filtro1=con1.sort_values(by='overall_satisfaction', ascending=False)\n",
    "filtro2=filtro1.sort_values(by='reviews', ascending=False)\n",
    "filtro2.head(3)"
   ]
  },
  {
   "cell_type": "code",
   "execution_count": 69,
   "id": "3ef5813c-93e9-4012-aeae-cda9913c13ec",
   "metadata": {},
   "outputs": [
    {
     "name": "stderr",
   ...
   "source": [
    ...
    "import pandas as pd\n",
    "df_airbnb = pd.read_csv(\"airbnb.csv\")\n",
    "filtro1 = df_airbnb[(df_airbnb.room_id==97503)|(df_airbnb.room_id==90387)]\n",
    "filtro1.to_excel('roberto.xls')"
   ]
  },
  {
   "cell_type": "code",
   "execution_count": 80,
   "id": "07fdca24-5e2d-4fff-8da3-692658d5e8cb",
   "metadata": {},
   "outputs": [
    {
     "data": {
   ...
   "source": [
    ...
    "import pandas as pd\n",
    "df_airbnb = pd.read_csv(\"airbnb.csv\")\n",
    "filtro1 = df_airbnb[(df_airbnb.price<=50)&(df_airbnb.room_type == \"Shared room\")]\n",
    "filtro2=filtro1.sort_values(by='price', ascending=True)\n",
    "filtro3=filtro2.sort_values(by='overall_satisfaction', ascending=False)\n",
    "filtro3.head(10)"
   ]
  },
  {
  ...
  },
  {
   "cell_type": "code",
   "execution_count": null,
   "id": "cde00148-b124-43d1-89f1-c0b8bf613213",
   "metadata": {},
   "outputs": [],
   "source": []
  }
